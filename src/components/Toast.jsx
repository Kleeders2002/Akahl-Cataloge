 ...
 *
 * Sistema de notificaciones elegante para acciones CRUD
 * - Success (verde) - Para crear, actualizar exitosamente
 * - Error (rojo) - Para operaciones fallidas
    ...
    <div className="animate-slide-up">
      <div className={`${config.bgColor} ${config.borderColor} ${config.textColor} border rounded-xl shadow-premium p-4 flex items-start gap-4 min-w-[320px] max-w-md`}>
        ...
        <div className="flex-1 min-w-0">
          {toast.title && (
            <p className="font-semibold text-base mb-1 tracking-wide">{toast.title}</p>
          )}
