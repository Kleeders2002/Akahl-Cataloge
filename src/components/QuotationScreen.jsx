  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card-premium animate-slide-up">
        <div className="h-px bg-gradient-to-r from-akahl-secondary via-akahl-secondary/50 to-transparent mb-5 divider-draw"></div>

        <div className="flex items-center gap-3 mb-5">
          <div className="w-1 h-6 bg-akahl-secondary rounded-full shadow-gold-glow"></div>
      ...
      {loadingFabrics ? (
        ...
        <div className="card-premium">
          <div className="text-center py-12">
            <div className="w-16 h-16 mx-auto mb-4 bg-akahl-primary/50 rounded-xl flex items-center justify-center border border-akahl-secondary/20 animate-float">
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="stagger-soft">
                  {displayedFabrics.map((fabric, index) => (
                    <tr
                      key={fabric.id}
                      className="row-lux border-b border-akahl-secondary/10 cursor-pointer"
              ...
              <div className="flex items-center justify-between py-4 px-2 border-t border-akahl-secondary/10">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-akahl-primary/50 hover:bg-akahl-primary/70 text-white font-medium rounded-lg transition-all active:scale-95 border border-akahl-secondary/20 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-akahl-primary/50 flex items-center gap-2"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-akahl-secondary hover:bg-akahl-secondary/80 text-akahl-primary font-medium rounded-lg transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-akahl-secondary flex items-center gap-2"
                  >
                    Next
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
